...
async def on_message(message):
    if message.content.upper().startswith('?SALES'):
        ...
        time.sleep(1)
        await client.edit_message(msg, "Getting ready... 16% done")
        time.sleep(1)
        await client.edit_message(msg, "Setting up order... 25% done")
        time.sleep(1)
        await client.edit_message(msg, "Setting up order... 47% done")
        time.sleep(1)
        await client.edit_message(msg, "Contacting services... 54% done")
        time.sleep(1)
        await client.edit_message(msg, "Contacting services... 69% done")
        time.sleep(1)
        await client.edit_message(msg, "Sending order... 76% done")
        time.sleep(1)
        await client.edit_message(msg, "Sending order... 83% done")
        time.sleep(1)
        await client.edit_message(msg, "Sending order... 94% done")
        time.sleep(1)
        await client.edit_message(msg, "Sending order... 99% done")
        time.sleep(3)
